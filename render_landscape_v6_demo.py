"""Generate the independent PW3 landscape V6 visual mockup."""

from pathlib import Path

from app import LANDSCAPE_HEIGHT, LANDSCAPE_WIDTH, PALETTE, load_fixture, prepare_data, render_landscape_v6


if __name__ == "__main__":
    data, degraded = prepare_data(load_fixture("fixtures/demo.json"))
    target = Path("public/pages/landscape-mockup-v6.png")
