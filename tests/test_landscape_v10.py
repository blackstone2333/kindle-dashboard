import unittest
from app import DEFAULT_FIXTURE, GRAY_LEVELS, LANDSCAPE_HEIGHT, LANDSCAPE_WIDTH, PALETTE, prepare_data, render_landscape_v10


class LandscapeV10Tests(unittest.TestCase):
    def test_v10_is_landscape_16_gray(self):
