import unittest
from app import DEFAULT_FIXTURE, GRAY_LEVELS, LANDSCAPE_HEIGHT, LANDSCAPE_WIDTH, PALETTE, prepare_data, render_landscape_v11


class LandscapeV11Tests(unittest.TestCase):
    def test_v11_is_landscape_16_gray(self):
